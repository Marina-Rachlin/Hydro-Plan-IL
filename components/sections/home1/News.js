                ...
                <div className="auto-container">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                        ...
                        <div className="inner-box">
                            ...
                            <figure className="image"><Link href="/blog-details"><img src="https://res.cloudinary.com/dmdv8s9mz/image/upload/v1706795159/hydro-plan/kd1yifowijexe9azmlom.jpg" alt="Article 1" style={{width: '350px', height: '220px'}}/></Link></figure>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                        ...
                        <div className="inner-box">
                            <div className="image-box">
                            <figure className="image" ><Link href="/blog-details"><img src="https://res.cloudinary.com/dmdv8s9mz/image/upload/v1706794956/hydro-plan/m3zrfaalvkid1baas6pj.jpg" alt="Article 2" /></Link></figure>
                            </div>
                            <div className="lower-content">
