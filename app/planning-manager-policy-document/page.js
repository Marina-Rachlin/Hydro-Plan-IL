  ...
  return (
    <>
      <Layout
        headerStyle={1}
        footerStyle={1}
        breadcrumbTitle="מסמך מדיניות מנהל התכנון"
      >
        <div>
              ...
              <div className="row clearfix">
                <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                  <div className="service-sidebar mr_40">
                    <SidebarArticles current={"planning-manager-policy-document"} />
                    <SidebarContact />
                  </div>
                </div>
                <div
                  ...
                  <div className="service-details-content">
                    <div className="content-one mb_90">
                      <figure className="image-box">
                        <img
                          src="https://res.cloudinary.com/dmdv8s9mz/image/upload/v1706795159/hydro-plan/kd1yifowijexe9azmlom.jpg"
                          alt=""
                    ...
                    <div className="content-four">
                      ...
                      <ul className="download-list clearfix">
                        <li>
                          ...
                          <span>Pdf</span>
                          <a href="/assets/article1.pdf" download="מסמך מדיניות מנהל התכנון.pdf">
